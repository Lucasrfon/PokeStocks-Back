...
import { Market, Pokemon } from "@prisma/client";
...
const marketShare = [
  1.33, 0.79, 0.35, 1.2, 0.69, 0.29, 1.19, 0.69, 0.29, 1.82, 1.82, 0.95, 1.82,
  1.82, 0.62, 1.42, 0.76, 0.3, 1.27, 0.5, 1.19, 0.37, 1.26, 0.44, 0.99, 0.39,
  0.75, 0.26, 1.25, 0.72, 0.27, 1.27, 0.72, 0.27, 1.21, 0.47, 1.38, 0.36, 1.19,
  0.46, 1.5, 0.39, 1.43, 0.87, 0.51, 1.37, 0.66, 1.09, 0.54, 1.37, 0.44, 1.09,
  0.42, 1.14, 0.35, 0.95, 0.35, 0.91, 0.17, 0.99, 0.54, 0.26, 1.92, 1.09, 0.62,
  0.87, 0.49, 0.24, 1.19, 0.69, 0.37, 1.37, 0.39, 0.83, 0.46, 0.17, 0.57, 0.29,
  0.87, 0.42, 1.5, 0.6, 0.71, 0.83, 0.26, 1.09, 0.42, 0.87, 0.31, 0.87, 0.11,
  1.5, 0.87, 0.49, 0.42, 1.25, 0.49, 0.6, 0.17, 0.99, 0.33, 0.99, 0.33, 0.91,
  0.49, 0.42, 0.42, 0.75, 0.87, 0.31, 0.54, 0.11, 0.42, 0.49, 0.19, 1.19, 0.46,
  0.87, 0.44, 1.04, 0.31, 0.83, 0.2, 0.79, 0.42, 0.42, 0.17, 0.16, 1.65, 0.16,
  0.24, 1.28, 1.04, 0.37, 0.37, 0.37, 0.87, 1.09, 0.42, 0.72, 0.22, 0.16, 0.2,
  0.22, 0.2, 0.19, 1.19, 0.57, 0.1, 0.01, 0.1,
];
const marketStartValue = [
...
const marketMaxAmount = [
  300, 120, 50, 300, 120, 50, 300, 120, 50, 1000, 370, 150, 1000, 370, 150, 300,
  120, 50, 370, 150, 300, 120, 300, 120, 300, 120, 300, 120, 300, 120, 50, 300,
  120, 50, 300, 120, 300, 120, 300, 120, 300, 120, 300, 120, 50, 300, 120, 300,
  120, 300, 120, 300, 120, 300, 120, 300, 120, 300, 120, 300, 120, 50, 300, 120,
  50, 300, 120, 50, 300, 120, 50, 300, 120, 300, 120, 50, 300, 120, 300, 120,
  300, 120, 120, 300, 120, 300, 120, 300, 120, 300, 120, 300, 120, 50, 80, 300,
  120, 300, 120, 300, 120, 300, 120, 300, 120, 80, 80, 80, 300, 120, 200, 70,
  80, 80, 80, 300, 120, 300, 120, 300, 120, 90, 80, 80, 80, 80, 80, 80, 1000,
...
function concatenateMarketData() {
  for (let i = 0; i < marketShare.length; i++) {
    marketData.push({
      pokemonId: i + 1,
      amount: marketMaxAmount[i],
      value: marketStartValue[i],
    });
  }
  return marketData;
}
